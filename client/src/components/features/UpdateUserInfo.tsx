    ...
    <FloatingPortal>
      {isOpen && (
        <FloatingFocusManager context={context} modal={false}>
          ...
          >
            <form
              className="bg-white dark:bg-[#242424] w-full min-w-[320px] max-w-[400px] p-6 rounded-lg border border-black/10 dark:border-white/5 shadow-2xl flex flex-col gap-5 animate-in fade-in zoom-in duration-200"
            ...
            >
              ...
              <div className="flex gap-3 justify-end mt-2">
                <button
                  type="button"
                  className="cursor-pointer px-4 py-2 text-sm font-medium text-gray-400 hover:text-black dark:hover:text-white transition-colors"
                  onClick={onClose}
                >
                  {t("cancel")}
                </button>
